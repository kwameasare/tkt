        ...
        GestureDetector(
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => EventDetails2(name, organiser, banner,
                        location, description, pricing, sessions, lat, lng, venue, ticket_types, event_id)));
          ...
          child: Slidable(
            ...
            secondaryActions: <Widget>[
              IconSlideAction(
                ...
                onTap: () => showInSnackBar('More'),
              ),
              IconSlideAction(
                caption: 'Delete',
                color: Colors.red,
                icon: Icons.delete,
                onTap: () => showInSnackBar('Delete'),
              ),
            ],
          ),
        ),
